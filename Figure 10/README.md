...
The current folder contains the source code files corresponding to Figure 10 in the paper.
...
Step 2: Run `CFM_derivation_method.py` to generate adversarial examples for the experiments shown in Figure 10.

Step 3: Run `CFM_Gaussian.py` to generate adversarial examples with Gaussian augmentation.

Step 4: Run `train_wth_val.py` for model training or validation as required.
