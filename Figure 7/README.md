...
The current folder contains the source code files corresponding to Figure 7 in the paper.
...
Step 2: Run `CFM_derivation_method.py` to generate adversarial examples for the experiments shown in Figure 7.

Step 3: Run `train_wth_val.py` to train models or perform validation as needed.
